...
> AI + 短视频 — 让每个人都能把自己的创意变成视频

## 项目简介

**cplan** 是一个面向普通人的 AI 短视频自动生成平台。

你不需要会写剧本、不需要懂分镜、不需要学剪辑——只要有一个想法，cplan 帮你把创意变成成品视频。

**你能做什么：**
- 💡 输入你的创意大纲（主题、要点、风格偏好）
- 🎬 AI 自动生成完整剧本（叙事结构 + 台词）
- 🖼️ 自动拆分分镜（每幕场景、画面描述、时长）
- 🎥 逐幕生成视频片段
- 🎞️ 自动合成成品视频，一键下载
...
- 📱 自媒体运营 — 批量产出高质量短视频
- 🏢 企业营销团队 — 低成本制作宣传视频
- 🎓 学生 / 普通用户 — 零门槛体验 AI 视频创作

> **核心理念**：创意不该被技术门槛挡住。你负责想，AI 负责做。

## 核心链路

```
你的创意大纲 → AI 生成剧本 → 自动拆分分镜 → 逐幕生成视频 → 合成成品视频 → 一键下载
```
